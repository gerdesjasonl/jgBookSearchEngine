...
<header>
 <h1 style="background-color: black;text-align: center;color:azure;">  jgBookSearchEngine (GraphQl Refactor Demo)  <img src='https://img.shields.io/badge/License-MIT-yellow.svg'>  </h1>
 <h3 style="text-align: center" id="projDesc">This is a previously developed, fully functioning Google Books API search engine built with a RESTful API. I have refactored it to be a GraphQL API built with an Apollo Server. The app was built using the MERN stack, with a React front end, MongoDB database, and Node.js/Express.js server and API.</h3>
